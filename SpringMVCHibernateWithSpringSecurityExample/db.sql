/* Execute the below scripts after connectiing to mysql as root user */

CREATE USER 'jobin'@'localhost' IDENTIFIED BY 'Password13#';

GRANT ALL PRIVILEGES ON * . * TO 'jobin'@'localhost';
